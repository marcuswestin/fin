...
*/
var require={};
require._=function(){var w=require["/Users/marcuswestin/Code/marcuswestin/fin/api/client"]={exports:{}},y=require._=function(){function k(b,c,e){if(b){if(!e){e=c;c=this}if(Object.prototype.toString.call(b)==="[object Array]")for(var h=0;h<b.length;h++)e.call(c,b[h],h);else for(h in b)e.call(c,b[h],h)}}var p=require["/Users/marcuswestin/Code/marcuswestin/fin/api/fin/util"]={exports:{}};p.exports={bind:function(b,c){if(!b||!c||typeof c=="string"&&!b[c]){console.log("bad bind arguments");debugger}var e=
...
var CustomModelPrototype=require._=function(){function w(){if(this._id)return this;p(this,function(){J(this,function(d){this._id=d;F.each(this._waitingForID,function(f){f(d)});delete this._waitingForID})});return this}var y=require["/Users/marcuswestin/Code/marcuswestin/fin/api/models/CustomModel"]={exports:{}};y.exports={_instantiate:function(d){var f;if(typeof d=="number")this._id=d;else f=d;f=f||{};for(var a in this._constructor.description){var b=F.bind(this,x,a,f[a],this._constructor.description[a]);
F.defineGetter(this,a,b)}this._id===undefined&&d!==undefined&&w.call(this)},create:w};var G=require._=function(){function d(q){this._value=q}function f(q,D){this._value=q;this._of=D;this._ofCustomModel=!!fin.models[this._of]}function a(q,D){this._value=q;this._of=D;this._ofCustomModel=!!fin.models[this._of]}function b(q){s(this,function(D,E){q(D,E)})}function c(q,D){s(this,function(E,z){z==q&&D(E,z)})}var e=require["/Users/marcuswestin/Code/marcuswestin/fin/api/models/propertyModels"]={exports:{}};
e.exports={Text:d,Number:d,List:f,Set:a};var h=e.exports,l=require["/Users/marcuswestin/Code/marcuswestin/fin/api/fin/util"].exports;d.prototype={observe:b,set:function(q){var D=this._propertyID,E=fin._holdTransaction();fin.models._waitForID(this._parent,function(z){E.resume();fin.set(z,[D],q);E.complete()})}};f.prototype={observe:b,on:c,push:function(q){H(this,"push",q)},unshift:function(q){H(this,"unshift",q)}};a.prototype={observe:b,on:c,add:function(q){H(this,"addToSet",q)},remove:function(q){H(this,
