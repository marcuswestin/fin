...
function _modelSet(value) {
	...
	fin.orm._waitForGUID(this._parent, function(itemID) {
...
function _modelCurrent(value) {
	...
	return fin.getCachedMutation(itemID, this._propertyID).value
}
...
var _getObservationInfo = function(propertyModel, callback) {
	...
	fin.orm._waitForGUID(propertyModel, function(id) {
...
var _collectionOp = function(propertyModel, op, value) {
	...
	fin.orm._waitForGUID(propertyModel._parent, function(parentID) {
		if (propertyModel._ofCustomModel) {
			fin.orm._waitForGUID(value, function(valueID) { completeTransaction(parentID, valueID) })
		} else {
