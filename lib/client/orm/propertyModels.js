...
function _modelSet(value) {
	...
	fin.orm._waitForID(this._parent, function(itemID) {
...
var _getObservationInfo = function(propertyModel, callback) {
	...
	fin.orm._waitForID(propertyModel, function(id) {
...
var _collectionOp = function(propertyModel, op, value) {
	...
	fin.orm._waitForID(propertyModel._parent, function(parentID) {
		if (propertyModel._ofCustomModel) {
			fin.orm._waitForID(value, function(valueID) { completeTransaction(parentID, valueID) })
		} else {
